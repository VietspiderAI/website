      ...
      <div className="mx-auto max-w-screen-xl px-4 pb-4 pt-8 sm:px-6 lg:px-8">
        <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
          <div className="mx-auto max-w-sm lg:max-w-none">
            <SquareLogo className="max-lg:mx-auto" />
          ...
          <div className="grid grid-cols-1 gap-8 text-center lg:grid-cols-3 lg:text-left">
            {Object.entries(quickLinks).map(([key, links]) => (
              <div key={key}>
                <strong className="font-medium capitalize text-primary">
                  {key}
                </strong>
        ...
        <div className="mt-16 border-t pt-4">
          <p className="text-center text-xs/relaxed">
            © VietSpiderAI {new Date().getFullYear()}. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
